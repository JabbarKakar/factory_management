...
abstract final class AppStrings {
  ...
  static const String transportAndVehicleInfo = 'Transport & Vehicle Info';
  static const String driverPhone = 'Driver Phone';
  static const String driverCnic = 'Driver CNIC / National ID';
  static const String vehicleType = 'Vehicle Type / Mode';
  static const String recentTransport = 'Recent Transport';
  static const String enterReceiverName = 'Enter receiver name';
  static const String enterReceiverPhone = 'Enter valid receiver phone number';
  static const String enterDeliveryAddress = 'Enter delivery address';
  static const String enterVehicleNumber = 'Enter vehicle number / plate';
  static const String enterDriverName = 'Enter driver name';
  static const String enterDriverPhone = 'Enter valid driver phone number';
  ...
  static const String dailyFinanceTitle = 'Cashflow';
  static const String dailyFinanceSubtitle =
      'Income received and expenses for the selected period';
  static const String dailyIncomeReceived = 'Income Received';
  static const String dailyExpenses = 'Expenses';

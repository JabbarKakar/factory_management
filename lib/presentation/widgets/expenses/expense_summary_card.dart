...
class ExpenseSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isThisMonth = periodFilter == ExpenseListPeriodFilter.thisMonth;
    final primaryTotal = isThisMonth ? monthTotal : filteredTotal;
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              Formatters.currencyPkr(primaryTotal),
                      ...
                      if (!isThisMonth) ...[
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 3),
                            Text(
                              Formatters.currencyPkr(monthTotal),

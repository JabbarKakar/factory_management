...
import 'dashboard_stock_cut_card.dart';

/// Period-aware small / large / total sales sq. ft — mirrors Stock Cut card.
class DashboardSalesSqFtCard extends StatelessWidget {
  const DashboardSalesSqFtCard({
  ...
  final DashboardSalesSqFtMetrics metrics;
                      ...
                      child: Column(
                        children: [
                          ...
                          _DetailRow(
                            ...
                            label: AppStrings.salesSqFtTotal,
                            value: DashboardStockCutCard.formatSqFt(
                              metrics.totalSqFt,
                            ),
  ...
  String _changeCaption(double? change, String vsLabel) {
    if (period == DashboardFinancePeriod.allTime) {
      return AppStrings.salesSqFtAllTimeCaption;
    }

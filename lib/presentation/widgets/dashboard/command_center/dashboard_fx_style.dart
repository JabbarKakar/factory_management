        ...
        children: [
          if (icon != null) ...[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: DashboardFx.primary.withValues(alpha: 0.28),
                ),
              ),
              child: Icon(icon, size: 15, color: DashboardFx.primary),
            ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(title, style: DashboardFxStyle.title),
                if (subtitle != null) ...[
                  const SizedBox(height: 2),
                  Text(subtitle!, style: DashboardFxStyle.subtitle),
                ],
              ],
            ),
          ),

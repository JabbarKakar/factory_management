...
class SupplierSummaryCard extends StatelessWidget {
  const SupplierSummaryCard({
    ...
    required this.marbleVendorCount,
    this.typeFilter,
    this.filteredCount,
    super.key,
  });
  ...
  final int marbleVendorCount;
  final SupplierType? typeFilter;
  ...
  Widget build(BuildContext context) {
    ...
    final accent = typeFilter != null
        ? supplierTypeAccent(typeFilter!)
        : AppColors.primary;
    ...
    final primaryLabel = typeFilter?.label ?? SupplierType.marbleBlockSlab.label;
    final primaryCount =
        typeFilter != null ? (filteredCount ?? 0) : marbleVendorCount;

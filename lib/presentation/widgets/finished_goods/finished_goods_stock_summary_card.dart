...
class FinishedGoodsStockSummaryCard extends StatelessWidget {
  const FinishedGoodsStockSummaryCard({
    required this.items,
  ...
  Widget build(BuildContext context) {
    ...
    final inStockCount = items.where((item) => item.hasStock).length;
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              AppStrings.totalInventoryValue,
                            ...
                            Text(
                              Formatters.currencyPkr(totalStockValue),
